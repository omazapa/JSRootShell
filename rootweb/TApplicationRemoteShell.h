...
#ifndef ROOT_TApplicationRemoteShell
#define ROOT_TApplicationRemoteShell
...
class TApplicationRemoteShell : public TApplication {
...
public:
   TApplicationRemoteShell(const char *url,const char *pass, Int_t debug = 0, const char *script = 0);
   virtual ~TApplicationRemoteShell();
...
//    ClassDef(TApplicationRemoteShell,0)  //Remote Application Interface
};
...
private:
   TApplicationRemoteShell *fApplicationRemoteShell;
public:
   TARInterruptHandler(TApplicationRemoteShell *r)
      : TSignalHandler(kSigInterrupt, kFALSE), fApplicationRemoteShell(r) { }
   Bool_t Notify();
};
